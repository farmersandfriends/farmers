...
public class MemberDataAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //img_flag.setImageURI( datas.get(position).getImgId() );

        final ImageView img_flag= (ImageView)convertView.findViewById(R.id.img_flag);
        final Uri myUri = datas.get(position).getImgId();
                ...
                try{
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {  // 화면에 그려줄 작업
                            img_flag.setImageBitmap(bm);
                        }
                    });
                    img_flag.setImageBitmap(bm); //비트맵 객체로 보여주기
                } catch(Exception e){
        ...
        TextView text_exp= (TextView)convertView.findViewById(R.id.text_exp);
        TextView text_grow= (TextView)convertView.findViewById(R.id.text_grow);
        ...
        text_exp.setText( String.valueOf(datas.get(position).getExp()));
        text_grow.setText( datas.get(position).getGrow() );
